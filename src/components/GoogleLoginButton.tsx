...
export default function GoogleLoginButton() {
  return (
    <button 
      ...
      className="px-8 py-4 bg-white text-gray-800 font-semibold rounded-xl shadow-sm border border-gray-200 hover:bg-gray-50 hover:-translate-y-1 transition-all duration-200 cursor-pointer flex items-center justify-center gap-3"
    >
