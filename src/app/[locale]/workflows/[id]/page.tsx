...
const demoNodes = [
  ...
  { 
    ...
    data: { label: 'ตรวจสอบความถูกต้องของเอกสาร', icon: '🔎', department: 'กองทะเบียนธุรกิจนำเที่ยวและมัคคุเทศก์', color: 'blue', sla: '1 วัน' } 
  },
  { 
    id: '3', type: 'custom', position: { x: 250, y: 350 }, 
    data: { label: 'รับชำระค่าธรรมเนียมและรับวางหลักประกัน', icon: '💰', department: 'กองทะเบียนธุรกิจนำเที่ยวและมัคคุเทศก์', color: 'blue', sla: '1 วัน' } 
  },
  { 
    id: '4', type: 'custom', position: { x: 250, y: 500 }, 
    data: { label: 'พิจารณาอนุมัติและออกใบอนุญาต', icon: '✅', department: 'กองทะเบียนธุรกิจนำเที่ยวและมัคคุเทศก์ (นายทะเบียน)', color: 'blue', sla: '3 วัน' } 
  }
];
