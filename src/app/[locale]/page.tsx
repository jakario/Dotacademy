      ...
      <div className="max-w-4xl mx-auto space-y-8">
        ...
        {!session ? (
          <div className="flex flex-col sm:flex-row gap-4 justify-center pt-8">
            <Link href="/api/auth/signin/google" className="px-8 py-4 bg-white text-gray-800 font-semibold rounded-xl shadow-sm border border-gray-200 hover:bg-gray-50 hover:-translate-y-1 transition-all duration-200 flex items-center justify-center gap-3">
