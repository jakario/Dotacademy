...
async function main() {
  ...
  const departments = [
    ...
    { name: 'กองทะเบียนธุรกิจนำเที่ยวและมัคคุเทศก์', description: 'จดทะเบียนและออกใบอนุญาตธุรกิจนำเที่ยวและมัคคุเทศก์', icon: '📋' },
    ...
    { name: 'กองกิจการภาพยนตร์และวีดิทัศน์ต่างประเทศ', description: 'ส่งเสริมและอำนวยความสะดวกการถ่ายทำภาพยนตร์ต่างประเทศ', icon: '🎬' },
  ];
